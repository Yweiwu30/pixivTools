...
class Ui_PixivTools(object):
	def setupUi(self, PixivTools):
		...
		self.FolderNameEdit = QLineEdit(self.layoutWidget7)
		self.FolderNameEdit.setObjectName(u"NameEdit")
		self.FolderNameEdit.setEnabled(False)

		self.horizontalLayout_17.addWidget(self.FolderNameEdit)
	...
	def retranslateUi(self, PixivTools):
		...
		self.label_3.setText(QCoreApplication.translate("PixivTools", u"\u6587\u4ef6\u5939\u540d\u79f0", None))
